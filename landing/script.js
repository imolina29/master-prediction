...
const translations = {
  en: {
    ...
    planQuarterlySavings: '$16.66/mo instead of $19.99/mo',
    planPromoBadge: 'World Cup 2026',
    planPromoName: 'World Cup Promo',
    planPromoPeriod: '/first month',
    planPromoAfter: 'Then $19.99/mo. Cancel anytime.',
  ...
  es: {
    ...
    planQuarterlySavings: '$16.66/mes en vez de $19.99/mes',
    planPromoBadge: 'Copa del Mundo 2026',
    planPromoName: 'Promo Mundial',
    planPromoPeriod: '/primer mes',
    planPromoAfter: 'Luego $19.99/mes. Cancela cuando quieras.',
