...
const translations = {
  en: {
    ...
    step1Desc:
      'We gather real-time stats, form data, head-to-head records, and odds from 5 top European leagues every day.',
    step2Title: 'AI Analysis',
    step2Desc:
      '6 independent ML models (XGBoost, Random Forest, Neural Network, and more) each generate a prediction for every match.',
    ...
    planQuarterlyBadge: 'Save 17%',
    planQuarterlyName: 'Quarterly',
    planQuarterlyPeriod: '/3 months',
    planQuarterlySavings: '$61,667/mo instead of $80,000/mo',
    planPromoBadge: 'World Cup 2026',
    planPromoName: 'World Cup Promo',
    planPromoPeriod: '/first month',
    planPromoAfter: 'Then $80,000/mo. Cancel anytime.',
    planFeature1: '5-10 daily premium picks',
    planFeature2: '5 leagues covered',
    planFeature3: 'Confidence scores & model breakdown',
    planFeature4: 'Pre-match analysis',
    ...
    faq1A:
      'We use 6 independent machine learning models (including XGBoost, Random Forest, and Neural Networks) trained on historical match data, team form, head-to-head records, and real-time statistics. Only picks where multiple models agree are shared.',
    faq2Q: 'What leagues do you cover?',
    faq2A:
      'We cover the top 5 European leagues: Premier League, La Liga, Bundesliga, Serie A, and Ligue 1. World Cup 2026 predictions will be added for premium subscribers.',
    faq3Q: 'Can I cancel anytime?',
    faq3A:
      'Yes. All plans can be cancelled at any time through the Telegram bot. Your access continues until the end of your current billing period.',
    faq4Q: 'What is your accuracy rate?',
    faq4A:
      'Our ensemble model maintains a 55%+ accuracy rate on match outcome predictions. We publish weekly performance reports so you can track results transparently.',
    faq5Q: 'How do I receive predictions?',
    faq5A:
  ...
  es: {
    ...
    planQuarterlyBadge: 'Ahorra 17%',
    planQuarterlyName: 'Trimestral',
    planQuarterlyPeriod: '/3 meses',
    planQuarterlySavings: '$61,667/mes en vez de $80,000/mes',
    planPromoBadge: 'Copa del Mundo 2026',
    planPromoName: 'Promo Mundial',
    planPromoPeriod: '/primer mes',
    planPromoAfter: 'Luego $80,000/mes. Cancela cuando quieras.',
